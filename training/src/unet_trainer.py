...
def parse_args(argv=None):
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Batch size for coated training",
    )
    parser.add_argument(
        "--img-size",
        type=int,
        default=512,
        help="Input image size for coated training",
    )
    parser.add_argument(
        "--epochs",
        type=int,
        default=300,
        help="Epoch count for coated training",
    )
    parser.add_argument(
        "--patience",
        type=int,
        default=50,
        help="Early stopping patience for coated training",
    )
    parser.add_argument(
        "--learning-rate",
        type=float,
        default=1e-3,
        help="Learning rate for coated training",
    )
    parser.add_argument(
        "--weight-decay",
        type=float,
